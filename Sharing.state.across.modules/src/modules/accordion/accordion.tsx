...
class Accordion extends React.PureComponent<IAccordionProps<IAccordionData>, IAccordianState> {
    ...
    public render(): JSX.Element {
        console.log('Accordion render - Customization from GHZ');
    ...
    private _onExpandAll(): void {
        console.log('expand all Clicked - Customized from GHZ');
    ...
    private _onCollapseAll(): void {
        console.log('collapse all button clicked - Customized from GHZ');
